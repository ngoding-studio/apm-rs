                 ...
                 <form id="formRegis">
                     ...
                     <div class="row">
                         <div class="col-lg-3 col-md-6 col-sm-6">
                             <p class="text-white mb-0">Poliklinik</p>
                             <h5 class="form-control form-control-md text-truncate shadow-none text-dark fs-5 fw-bold bg-glasses">{{session()->get('session_nm_poli')}}</h5>
                         </div>
                         <div class="col-lg-3 col-md-6 col-sm-6">
                             <p class="text-white mb-0">Dokter</p>
                             <h5 class="form-control form-control-md text-truncate shadow-none text-dark fs-5 fw-bold bg-glasses">{{session()->get('session_nm_dokter')}}</h5>
                         </div>
                         <div class="col-lg-3 col-md-6 col-sm-6">
                             <p class="text-white mb-0">Cara Bayar</p>
                             <h5 class="form-control form-control-md text-truncate shadow-none text-dark fs-5 fw-bold bg-glasses">{{session()->get('session_nm_bayar')}}</h5>
                         </div>
                         <div class="col-lg-3 col-md-6 col-sm-6">
